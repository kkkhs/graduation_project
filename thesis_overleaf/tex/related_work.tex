...
工程工具链的成熟也改变了这类课题的组织方式。MMDetection\cite{mmdet2018_openmmlab} 和 Ultralytics\cite{ultralytics2024_docs} 已经提供了训练、测试和部署所需的基础设施，使不同模型之间的复现和比较更可操作。相关工作也逐渐重视评测协议、复现记录和实验流程的一致性，而这种一致性通常也借助 COCO、VOC 等通用基准协议来统一理解\cite{lin2014_coco,everingham2010_voc}。

本文从通用目标检测、小目标检测和遥感船舶检测三条路线展开梳理，各路线的代表方法与本文定位之间的关系见图~\ref{fig:ch2_research_map}。
