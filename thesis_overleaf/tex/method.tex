...
FCOS 的基本流程见图~\ref{fig:ch3_fcos_pipeline}。输入图像过 Backbone 和 FPN 之后生成多尺度特征，检测头直接预测类别、边框偏移和 centerness 分数。FCOS 无显式 anchor 设计，在遥感微小船舶场景中，其 Precision--Recall 折中表现值得关注。
