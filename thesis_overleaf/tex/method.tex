...
\begin{figure}[htbp]
  \centering
  \includesvg[width=0.92\textwidth]{ch3_preprocess_flow}
...
\begin{figure}[htbp]
  \centering
  \includesvg[width=0.95\textwidth]{ch3_drenet_overview}
  \caption{DRENet 方法示意}
...
\begin{figure}[htbp]
  \centering
  \includesvg[width=0.95\textwidth]{ch3_fcos_pipeline}
  \caption{FCOS 检测流程示意}
...
\begin{figure}[htbp]
  \centering
  \includesvg[width=0.95\textwidth]{ch3_yolo_pipeline}
