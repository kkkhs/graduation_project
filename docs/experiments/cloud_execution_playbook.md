...
yolo detect train model=yolov8n.pt data=/data/LEVIR-Ship/ship.yaml imgsz=640 epochs=1 batch=2 device=0 project=/workspace/runs name=yolo_smoke
```
...
yolo detect train model=yolov8n.pt data=/data/LEVIR-Ship/ship.yaml imgsz=640 epochs=100 batch=4 device=0 project=/workspace/runs name=yolo_main
```
